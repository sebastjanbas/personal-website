    ...
    <footer className="h-fit w-screen p-5 sm:p-10 xl:p-20">
      <div className="flex flex-row justify-start gap-32 items-start w-fit h-fit">
        <h1 className="bg-clip-text bg-gradient-to-br from-black via-slate-500 to-white tracking-tight text-4xl sm:text-6xl md:text-8xl lg:text-[150px] font-bebasNeue font-black uppercase text-transparent">
          Lets&apos;s work <br />
          <strong className="text-8xl sm:text-[150px] md:text-[200px] lg:text-[300px]">
            together
          </strong>
        </h1>
        <div className="hidden 2xl:flex w-full h-full flex-col gap-5 translate-y-8 justify-center items-center">
          ...
          <h2 className="text-6xl font-light tracking-tighter uppercase text-slate-500 ">
            <span
              className="
       duration-200 ease-out 
      after:block after:h-[1px] after:origin-left after:scale-x-0 after:bg-slate-500 
