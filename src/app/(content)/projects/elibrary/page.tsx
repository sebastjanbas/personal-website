...
const ELibraryPage = () => {
  return (
    <section className="h-screen mt-20 w-screen p-5 md:p-10 xl:p-20">
      <h1 className="bg-clip-text bg-linear-to-b from-black via-slate-500 to-white text-7xl md:text-[120px] lg:text-[138px] xl:text-[160px] 2xl:text-[180px] text-center text-transparent pb-2 font-semibold tracking-tight font-bebasNeue">
        E - Library
      </h1>
